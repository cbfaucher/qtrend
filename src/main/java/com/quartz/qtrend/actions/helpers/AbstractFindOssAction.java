...
public class AbstractFindOssAction implements QEventHandler, JFrameAware<QTrendFrame>, QTrendConstants.UserPropertyNames
{
    ...
    protected boolean askQuestions()
    {
        fromDate = ActionHelper.askDate(parent, "Since what date?",
                                        userProperties.getProperty( QTrendConstants.UserPropertyNames.USERPROP_LAST_SINCE_DATE,
        ...
        final String minimumPriceStr = JOptionPane.showInputDialog(parent, "Minimum price?", userProperties.getPropertyAsFloat(USERPROP_MINIMUM_PRICE, 1.00f));
        ...
        final String volumeStr = JOptionPane.showInputDialog(parent, "Minimum volume?", userProperties.getPropertyAsInt(USERPROP_MINIMUM_VOLUME, 100000));
