...
public class LangfordDataImplTest extends TrendTestCase
{
    ...
    public void test_calculateVariation() throws Exception
    {
...

        {
            ...
            assertEquals("", langfordData1.getSignal());
        }

        {
            ...
            assertEquals("OBS", langfordData2.getSignal());
        }

        {
            ...
            assertEquals("", langfordData3.getSignal());
        }

        {
            ...
            assertEquals("", langfordData4.getSignal());
        }

        {
            ...
            assertEquals("OSS", langfordData5.getSignal());
        }

        {
            ...
            assertEquals("", langfordData6.getSignal());
        }
