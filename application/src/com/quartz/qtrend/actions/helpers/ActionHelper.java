...
public final class ActionHelper
{
    ...
    static public Ticker askExchange(QTrendFrame pParent)
    {
        ...
        final String lastExchange = userProperties.getUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_EXCHANGE, null);
        ...
        userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_EXCHANGE, exchange.toString());
        return exchange;
    ...
    static public Ticker askNewExchange(QTrendFrame pParent)
    {
        ...
        userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_EXCHANGE, name);
    ...
    {
        final QUserProperties userProperties = QTrendBeanNames.USER_PROPERTIES.getBean();
        final String lastTicker = userProperties.getUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_TICKER, "");

        String value = JOptionPane.showInputDialog(pParent, "What is the ticker?",
                                                   lastTicker);
        if (value == null) return null;
        userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_TICKER, lastTicker);
    ...
    public static YearMonthDay askDate(final QTrendFrame pFrame, String pMsg, String pDefaultValue)
    {
        try
        {
            final String value = JOptionPane.showInputDialog(pFrame, pMsg, pDefaultValue);
            if (value == null) return null;
            return DateUtilities.toYearMonthDay(value);
        }
