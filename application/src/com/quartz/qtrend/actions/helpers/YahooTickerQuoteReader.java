...
public class YahooTickerQuoteReader
{
    ...
    public void read(Ticker pTicker, YearMonthDay pStartDate, YearMonthDay pEndDate, LineParser pLineParser) throws ImporterException
    {
        try
        {
            //  build URL
    ...
    private URL buildURL(final Ticker pTicker, final YearMonthDay pStartDate, final YearMonthDay pEndDate)
