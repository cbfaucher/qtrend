...
public class ShowStockchartGraphicsAction implements QEventHandler, JFrameAware<QTrendFrame>
{
    ...
    public void handleEvent(QEventManager pEventManager, EventObject pEvent, String pCommand)
    {
        ...
        if (ticker == null)
        {
            ticker = JOptionPane.showInputDialog(parent, "What is the ticker?", userProperties.getUserProperty(
        ...
        final String monthstr = JOptionPane.showInputDialog(parent, "For how many months back?", userProperties.getUserPropertyAsInt(
                QTrendConstants.UserPropertyNames.USERPROP_MONTHS_BACK, 3));
        if (monthstr == null) return;
        userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_MONTHS_BACK, monthstr);
