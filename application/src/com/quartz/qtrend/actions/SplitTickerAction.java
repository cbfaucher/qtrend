...
public class SplitTickerAction implements QEventHandler, JFrameAware<QTrendFrame>
{
    ...
    public void handleEvent(QEventManager pEventManager, EventObject pEvent, String pCommand)
    {
        try
        {
            ...
            //  ticker
            final String value = JOptionPane.showInputDialog(parent, "What is the ticker?", userProperties.getUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_TICKER, ""));
            if (value == null) return;
            userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_LAST_TICKER, value);
