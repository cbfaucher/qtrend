...
public class FindMacdOssAction extends AbstractFindOssAction
{
    ...
    protected boolean askQuestions()
    {
        ...
        final String rsiStr = JOptionPane.showInputDialog(parent, "RSI above?", userProperties.getUserPropertyAsInt(USERPROP_OSS_MINIMUM_RSI, 70));
        if (rsiStr == null) return false;
        minimumRsi = new Integer(rsiStr.trim());
        userProperties.setUserProperty(USERPROP_OSS_MINIMUM_RSI, minimumRsi.toString());
