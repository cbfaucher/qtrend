...
public class QTrendFileDialog extends JFileChooser
{
    ...
    public QTrendFileDialog()
    {
        ...
        this.setCurrentDirectory(new File(userProperties.getUserProperty(
    ...
    public int showOpenDialog(Component parent) throws HeadlessException
    {
        ...
        if (result == JFileChooser.APPROVE_OPTION)
        {
            ...
            userProperties.setUserProperty(QTrendConstants.UserPropertyNames.USERPROP_IMPORT_DIRECTORY, directory);
        }
